...
class InferenceFrame(tk.LabelFrame):
    ...
    def generate_widgets(self):
        self.model_folder_button = tk.Button(self,text="Select a model",command = self.model_folder_setter)
        self.data_folder_button = tk.Button(self,text="Select an input folder",command = self.data_folder_setter)
        self.out_folder_button = tk.Button(self,text="Select an output folder",command = self.output_folder_setter)
        ...
        self.big_button = tk.Button(self,text="Launch Inference",command=self.launch_inference)
    ...
    def model_folder_setter(self):
        self.model_folder.set(filedialog.askdirectory(title="Select a model folder"))
